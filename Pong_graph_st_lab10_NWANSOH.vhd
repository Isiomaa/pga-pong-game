...
-- ====================================================
    begin
        process (clk, reset)
            begin
                if (reset = '1') then
                    bar_x_reg <= to_unsigned(600, 10);
                    bar_y_reg <= to_unsigned(400, 10);
                    ball_x_reg <= (others => '0');
                    ball_y_reg <= (others => '0');
...
-- if btn 0 pressed and paddle not at bottom yet
                    if ( btn(3) = '1' and bar_y_b < (MAX_Y - BAR_V)) then
                        bar_y_next <= bar_y_reg + BAR_V;
-- if btn 3 pressed and bar not at top yet
        ...
        bool_l <= '1' when (btn(1) = '1') and (bar_x_l > (BAR_H)) else '0';
        bool_r <= '1' when (btn(2) = '1') and (bar_x_r < MAX_X - 1 - BAR_H) else '0';
